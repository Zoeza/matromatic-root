	...
	function(a) {
		...
		var s = {
			...
			t = {
				...
				"/matromatic-root/site/public/static/js/components/sliders.js": !0,
				"matromatic-root/site/public/static/js/components/breadcrumbs.js": !0,
				"matromatic-root/site/public/static/js/components/info-box.js": !0,
				"matromatic-root/site/public/static/js/components/shop-components-tiles.js": !0,
				"matromatic-root/site/public/static/js/components/blog-page.js": !0
			},
			c = {
				component__map: {
					js: ["https://maps.googleapis.com/maps/api/js?key=" + Berserk.settings.gmap_api_key, "matromatic-root/site/public/static/js/components/google-maps.js"]
				},
				twitter_init: {
					js: ["js/assets/twitter-init.js"]
				},
				recaptcha: {
					js: ["https://www.google.com/recaptcha/api.js?render=" + Berserk.settings.recaptcha_api_key, "matromatic-root/site/public/static/js/assets/recaptcha.js"]
				}
			},
			d = {};
		...
		var n = {
			...
			component__shape_box: {
				...
				js: ["/matromatic-root/site/public/static/js/components/shape-box.js"]
			},
			component__steps: {
			...
			component__title_section: {
				css: ["/matromatic-root/site/public/static/css/components/section-titles.css"]
			},
			component__delimiters: {
				css: ["/matromatic-root/site/public/static/css/components/delimiters.css"]
			},
			component__backgrounds_css: {
				css: ["/matromatic-root/site/public/static/css/components/backgrounds.css"]
			},
			component__backgrounds_js: {
				js: ["/matromatic-root/site/public/static/js/components/backgrounds.js"]
			},
			...
			component__image_caption_css: {
				css: ["/matromatic-root/site/public/static/css/components/image-caption-parallax.css"]
			},
			component__image_caption: {
				dependency: ["component__image_caption_css", "assets__image_caption"]
			},
			component__tags: {
				css: ["/matromatic-root/site/public/static/css/components/tags.css"]
			},
			component__tags_js: {
				js: ["/matromatic-root/site/public/static/js/components/tags.js"]
			},
			component__timelines_css: {
				css: ["/matromatic-root/site/public/static/css/components/timelines.css"]
			},
			...
			component__shop_cards: {
				css: ["/matromatic-root/site/public/static/css/components/shop-components-cards.css"]
			},
			component__shop_flip: {
				css: ["/matromatic-root/site/public/static/css/components/shop-components-flip.css"],
				js: ["/matromatic-root/site/public/static/js/components/shop-components-flip.js"],
				dependency: ["scrollbar"]
			},
			component__shop_item_page_sidebar: {
				css: ["/matromatic-root/site/public/static/css/components/shop-components-item-sidebar.css"]
			},
			component__elements: {
				css: ["/matromatic-root/site/public/static/css/components/elements.css"],
				js: ["/matromatic-root/site/public/static/js/components/elements.js"]
			},
			component__header: {
				dependency: ["flexmenu"],
			...
			component__gallery: {
				css: ["/matromatic-root/site/public/static/css/components/gallery-cols.css"],
				dependency: ["fancybox"]
			},
